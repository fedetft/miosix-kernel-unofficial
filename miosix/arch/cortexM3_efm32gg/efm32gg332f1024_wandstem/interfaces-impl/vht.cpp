...
namespace miosix
{
    ...
    void Vht::IRQinit()
    {
        ...
        unsigned int nowRtc = Rtc::IRQgetTimerCounter();
        Rtc::IRQsetVhtMatchReg(nowRtc+1);
    ...
    void Vht::IRQupdateImpl(long long syncPointTheoreticalHsc, long long syncPointExpectedHsc, long long clockCorrectionFlopsync)
    {
        ...
        long long bTicks = syncPointTheoreticalHsc - (a * syncPointExpectedHsc);
